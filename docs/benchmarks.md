...
| Prefill pp64 (chunk 64) | 142.8 t/s | **148.9 t/s** (81.8 exact mode) | **1.04x** (0.57x) |
| Prefill pp128 (… + odd-type tiles nl/q3k/iq3s) | — | **220.5 t/s** (fresh-ref verified) | 0.75x vs llama-bench 294 |
| Prefill pp512 (long context) | — | **174.3 t/s** | 0.49x vs llama-bench 358 |
