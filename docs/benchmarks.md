...
| Prefill pp64 (chunk 64) | 142.8 t/s | **152.0 t/s** (81.8 exact mode) | **1.06x** (0.57x) |
| Prefill pp128 (… + odd tiles + flash + q8/GDN) | — | **237.4 t/s** (fresh-ref verified) | 0.81x vs llama-bench 294 |
| Prefill pp512 (long context) | — | **217.5 t/s** | 0.61x vs llama-bench 358 |
