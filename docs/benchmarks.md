...
| Prefill pp64 (chunk 64) | 142.8 t/s | **99.8 t/s** (81.8 exact mode) | 0.70x (0.57x) |
| Prefill pp128 (chunk 128, J-tiles) | — | **111.0 t/s** (numerically verified) | 0.38x vs llama-bench 294 |
