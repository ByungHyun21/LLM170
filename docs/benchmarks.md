...
| Prefill pp128 (… + odd tiles + flash + q8 tile) | — | **232.9 t/s** (fresh-ref verified) | 0.79x vs llama-bench 294 |
| Prefill pp512 (long context) | — | **212.1 t/s** | 0.59x vs llama-bench 358 |
