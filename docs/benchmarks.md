...
| Prefill pp64 (chunk 64) | 142.8 t/s | **118.5 t/s** (81.8 exact mode) | 0.83x (0.57x) |
| Prefill pp128 (… + vectorized staging q5k+q4k+xs) | — | **160.7 t/s** (fresh-ref verified) | 0.55x vs llama-bench 294 |
