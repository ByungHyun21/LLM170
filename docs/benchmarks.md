...
| Prefill pp64 (chunk 64) | 142.8 t/s | **169.5 t/s** (81.8 exact mode) | **1.19x** (0.57x) |
| Prefill pp128 (… + drain swap + wavesplit) | — | **245.1 t/s** (fresh-ref verified) | 0.83x vs llama-bench 294 |
| Prefill pp512 (long context) | — | **223.8 t/s** | 0.62x vs llama-bench 358 |
