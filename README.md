...
| | pp512 | pp4096 | pp16384 | tg128@512 | tg128@16k |
|---|---|---|---|---|---|
| LLM170 | **360** | 324 | 253 | 11.4 | 10.5 |
| llama.cpp | 347 | **342** | **317** | **11.9** | **11.9** |

#### Qwen3.8-Flash-Next (177B-A3B, Q4_K_XL 103.7 GiB)

| | pp512 | pp4096 | pp16384 | tg128@512 | tg128@16k |
|---|---|---|---|---|---|
| LLM170 | **251** | **270** | **243** | 16.8 | 16.1 |
| llama.cpp | 206 | 237 | 229 | **19.8** | **20.0** |
