...
pub const NAMES: &[&str] = &[
    "quant_q8", "q4_gemm_q5_1", "q4_gemm_f32", "q4_qsa_attn", "q4_silu_div", "q4_sigmoid", "q4_scale", "q4_l2_rows", "q4_hc_gate_mean", "q4_hc_combine", "q4_norm_gated_sig", "q4_moe_top10", "q4_moe_top10_m", "q4_moe_weighted_sum", "q4_moe_gather", "q4_moe_scatter", "q4_rows_permute_u32", "q4_gemm_q5_1_t", "q4_gemm_q5_1_m", "q4_gemm_f32_m", "q4_gemm_q4k_m", "q4_gemm_q4k_g", "q4_gemm_q4k_x", "q4_gemm_q4k_y", "q4_axpy_scaled_t", "q4_gdn_ar_w", "silu_mul_f32", "dequant_q6k_f16", "dequant_q4k_f16", "requant_q6k_canonical", "rmsq", "gemm_q5k2", "silu_mulq", "gatedq",
