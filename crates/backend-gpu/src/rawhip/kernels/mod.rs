...
pub const NAMES: &[&str] = &[
    ...
    "q4_idx_q_rope", "q4_idx_bk_update", "q4_idx_score", "q4_idx_rank", "q4_idx_expand", "q4_gemm_f32_w", "q4_idx_topk", "gemm_q8_0_w", "q4_gemm_q5_1_w_ids", "gemm_q8_0_ids", "qsa_flash_wk8i",
];
