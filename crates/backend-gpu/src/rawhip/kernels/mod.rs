...
pub const NAMES: &[&str] = &[
    ...
    "qsa_score", "qsa_mix2", "qsa_flash", "qsa_flash_split4q4", "qsa_flash_gqa", "qsa_flash_gqa2", "qsa_flash_gqa2h", "kv_f16", "qsa_flash_gqa2d", "qsa_flash_wk", "qsa_flash_wk16", "qsa_flash_wk8", "qsa_flash_merge", "gemm_iq3s", "dp4a_probe", "bw_probe", "q4_gemm_f32_w2", "gemm_mix_dual", "gdn_conv_t", "gdn_conv_t2", "gdn_conv_t2_f32", "gdn_conv_state", "gdn_ar_w_swap", "gemm_q5k_v2", "gemm_q8_0_dual", "gemm_q5k4", "gemm_xs4", "gemm_q4k4", "gemm_q6k4", "cat2_rows", "gdn_ar_sm", "gdn_ar_t", "gdn_ar_w", "gdn_ar_chunk_a", "gdn_ar_chunk_b", "gdn_ar_chunk_c2", "l2_rows2_scale_w", "kv_append_t", "gemm_q5k_mm", "gemm_q5k_wm", "dequant_f16_q5k",
    "q4_idx_q_rope", "q4_idx_bk_update", "q4_idx_score", "q4_idx_rank", "q4_idx_expand", "q4_gemm_f32_w", "q4_idx_topk", "gemm_q8_0_w", "gemm_q8_0_mt", "gemm_q8_0_mt_w", "gemm_q8_0_w4", "gemm_q8_0_w16", "q4_gemm_q5_1_w_ids", "gemm_q8_0_ids", "qsa_flash_wk8i", "rms_small", "q4_ple_gate", "q4_ple_conv", "q4_ple_residual", "argmax_rows_s1", "argmax_rows_s2", "gdn_ar_w_np", "gdn_conv_np", "gemm_q8_0_mt16", "gemm_q5k4_w2", "gemm_q4k4_w2", "qsa_flash_wmma2v2", "q4_gemm_f32_mt",
    "q4_shexp_gu", "q4_shexp_da",
    "add_f32", "argmax64", "dequant_f16_xs", "dequant_f16_xs_dbg", "flash_vit", "gdn_conv_state_ms", "gdn_conv_t2_ms", "gdn_conv_t2_ms_f32", "gelu_t", "gemm_f32t", "gemm_q4k_mm", "gemm_q4k_wm", "gemm_q5k_wc", "gemm_q6k_mm", "gemm_q6k_wm", "gemm_q8_0_w256", "gemm_xs_mm", "gemm_xs_wc", "gemm_xs_wm", "layernorm_t", "pack_strided", "vit_rope",
];
